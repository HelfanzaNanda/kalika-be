...
func (service *UnitServiceImpl) Datatable(ctx echo.Context) (res web.Datatable, err error) {
	...
	unitRepo, totalData, totalFiltered, _ := service.UnitRepository.Datatable(ctx, tx, draw, limit, start, search)
	// if err != nil {
	// 	return helpers.Response(err.Error(), "", nil), err
	// }

	data := make([]interface{}, 0)
	for _, v := range unitRepo {
